describe('Gift cards admin', () => {
  ...
  it('send gift cards by emails', () => {
    ...
    cy.get(multiEmailSelector).type('test1@qpayee.com');
    ...
    cy.get(multiEmailSelector).type('{selectall} test1@qpayee.com test2@qpayee.com test3@qpayee.com');
    ...
    cy.getByDataCy('back-to-giftcards-list').click();
    cy.getByDataCy('gift-cards-list').contains('$12.00 sent to test3@qpayee.com');
  });
});
