...
const ContributeFAQ = ({ collective, ...props }) => (
  <FAQ withBorderLeft withNewButtons {...props}>
      ...
      <Content>
        <FormattedMessage
          ...
          values={{
            Link: getI18nLink({
              openInNewTab: true,
              href: 'https://docs.qpayee.com/help/financial-contributors/platform-tips',
            }),
          }}
        />
      </Content>
    ...
    <Box mt={2}>
      <StyledLink
        as={StyledLink}
        href="https://docs.qpayee.com/help/financial-contributors/payments#financial-contribution-flow"
        openInNewTab
        fontSize="12px"
        color="black.700"
      >
