        ...
        <Box width={['288px', '676px', '458px', null, '558px']} mb={['24px', null, null, null, '24px']}>
          <MainDescription textAlign={['center', null, 'left']}>
            <FormattedMessage
              ...
              defaultMessage="QPayee is purpose-built to streamline your processes, reduce overhead, increase transparency, and enable your organization to hold and manage funds for more projects in less time. <learnMoreLink>Learn more</learnMoreLink>."
              values={{
