...
<Canvas>
  <Story name="Loading / Submitting">
    {() => {
      return <SignIn loading onSubmit={() => {}} onSecondaryAction={() => {}} email="test+betree@qpayee.com" />;
    }}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="With Unknown Email">
    {() => {
      return (
        <SignIn onSubmit={() => {}} onSecondaryAction={() => {}} unknownEmail email="test+betree@qpayee.com" />
      );
    }}
  </Story>
</Canvas>
