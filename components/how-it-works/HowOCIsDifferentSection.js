...
const HowOCIsDifferent = () => {
  return (
    <Flex mx={[3, 4]} my={4} mt={['88px', null, '120px']} flexDirection="column" alignItems="center" textAlign="center">
      <Box width={['288px', '100%']}>
        <SectionTitle>
          <FormattedMessage id="howItWorks.HowOCIsDifferent.title" defaultMessage="QPayee is different" />
        </SectionTitle>
      </Box>
        ...
        <Box width={['288px', '264px', '358px', null, '472px']} textAlign={['center', 'left']} mr={[null, 2, null, 5]}>
          ...
          <Description>
            <FormattedMessage
              ...
              defaultMessage="Unlike other crowdfunding platforms, QPayee is designed for ongoing collaborations. That means your funding and community of support doesn’t disappear after a single campaign, or if the initial organizers move on."
            />
          </Description>
        </Box>
      </Flex>
