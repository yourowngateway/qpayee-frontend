        ...
        <Box maxWidth={['288px', '701px']} mt="35px" px="16px">
          ...
          >
            <FormattedMessage
              ...
              defaultMessage="Whether you're a <mutualAidLink>mutual aid group</mutualAidLink>, a <communityLink>community initiative</communityLink>, an <opensourceLink>open-source software project</opensourceLink>, or a <climateLink>climate change activist</climateLink>, QPayee helps groups unlock access to money."
              values={{
                u: I18nUnderline,
