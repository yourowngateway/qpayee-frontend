...
<Meta
  ...
  argTypes={{
    ...
    toast: {
      defaultValue: {
        ...
        message: (
          <p>
            A toast message that can have <a href="https://qpayee.com">links</a> or <i>text formatting</i> --
  ...
  args={{
    toast: {
      ...
      message: (
        <p>
          A toast message that can have <a href="https://qpayee.com">links</a> or <i>text formatting</i> -- it's
          pretty flexible!
        </p>
      ),
    },
