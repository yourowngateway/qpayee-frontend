            ...
            loading ? (
              ...
              <Box>
                <Flex flexDirection="column" alignItems="center" mb={3}>
                  ...
                  <StyledLink openInNewTab href={`https://qpayee.com/${this.props.collectiveSlug}`}>
                    <FormattedMessage
    ...
    return (
      <IFrameContainer linkColor={style} ref={node => (this.node = node)}>
        ...
        {backers.organizations + backers.collectives + backers.users === 0 && (
          <a target="_blank" rel="noopener noreferrer" href={`https://qpayee.com/${collectiveSlug}`}>
            <ContributeButton />
          </a>
        )}
        ...
        {backers.organizations + backers.collectives > 0 && (
          <section id="organizations" className="tier">
            ...
            <div className="actions">
              <a
                href={`https://qpayee.com/${collectiveSlug}`}
                target="_blank"
